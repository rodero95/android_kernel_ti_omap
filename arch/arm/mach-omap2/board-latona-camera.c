/*
 * linux/arch/arm/mach-omap2/board-latona-camera.c
 *
 * Copyright (C) 2007 Texas Instruments
 *
 * Modified from mach-omap2/board-zoom2-camera.c for Samsung latona board.
 *
...
struct lv8093_platform_data latona_lv8093_platform_data = {
...
static u32 imx046_sensor_set_xclk(struct v4l2_int_device *s, u32 xclkfreq)
{
	...
	return isp_set_xclk(vdev->cam->isp, xclkfreq, CAMLATONA_USE_XCLKB);
}
...
struct imx046_platform_data latona_imx046_platform_data = {
...
void __init latona_cam_init(void)
{
	cam_inited = 0;
	/* Request and configure gpio pins */
